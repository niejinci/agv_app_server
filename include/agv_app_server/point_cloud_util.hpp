...
/*
    ...
    2. 再平移
*/
inline void render(sensor_msgs::msg::PointCloud2::SharedPtr msg, agv_service::msg::AgvPosition agv_pos, agv_app_msgs::msg::AppData& app_data) {
    ...
    if (!has_x || !has_y || !has_z) {
        app_data.success = false;
        app_data.message = "PointCloud2 is invalid: missing x/y/z fields";
        return;
    }
    ...
    for (; iter_x != iter_x.end(); ++iter_x, ++iter_y, ++iter_z, ++iter_intensity) {
        ...
        app_data.points.emplace_back(agv_app_msgs::msg::PointXyzi()
...
inline void render(geometry_msgs::msg::PolygonStamped::SharedPtr msg, agv_service::msg::AgvPosition agv_pos, agv_app_msgs::msg::AppData& app_data)
{
